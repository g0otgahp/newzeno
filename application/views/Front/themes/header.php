...
<div style="background-color:#3a3f44;">
  <nav class="container" role="navigation" style="margin-bottom:10px;">
...
<div class="collapse navbar-collapse" style="padding:0px;">
  ...
  <ul class="nav nav-tabs">
    <li class="active" ><a data-toggle="tab" href="#Home" data-toggle="dropdown"><i class="icon-home" style="font-size: 16px; padding-top:3px;"></i> หนัาหลัก</a></li>
    <li><a data-toggle="tab" href="#menu1" data-toggle="dropdown">Display Infomation <i class="icon-chevron-down" style="padding-top:3px;"></i></a></li>
    <li><a data-toggle="tab" href="#menu2">อุปกรณ์แสดงภาพ <i class="icon-chevron-down" style="padding-top:3px;"></i></a></li>
    <li class="pull-right"><a data-toggle="tab" href="#search"><i class="icon-search" style="padding-top:3px;"></i></a></li>
  </ul>
  ...
  <div class="container">
    ...
    <div class="tab-content" style="margin-bottom:0px;">
      ...
      <div id="Home" class="tab-pane fade active in" style="margin-top:20px;">
        <?php $this->load->view('Front/themes/slide'); ?>
</div>

<div id="search" class="tab-pane fade in" style="margin-top:20px;">
  <center>
  <?php echo form_open('Search'); ?>
  <b>ค้นหา : </b><input style="margin-top:10px; padding:15px;" type="text" name="keyword">
  <button type="submit" class="btn btn-primary btn-sm">ยืนยัน</button>
  <?php echo form_close(); ?>
</center>
</div>

      <div id="menu1" class="tab-pane fade in" style=" margin-top:20px;">
        <div class="col-md-3">
          <ul class="multi-column-dropdown">
          <li class="btn btn-block"><a href="#" style="color:orange;"><b><u>Digital Signage</u></b></a></li>
        ...
        <div class="col-md-3">
          <ul class="multi-column-dropdown">
          <li class="btn btn-block"><a href="#" style="color:orange;"><b><u>Commercial TV</u></b></a></li>
        ...
        <div class="col-md-3">
          <ul class="multi-column-dropdown">
          <li class="btn btn-block"><a href="#" style="color:orange;"><b><u>OLED Signage</u></b></a></li>
        ...
        <div class="col-md-3">
          <ul class="multi-column-dropdown">
          <li class="btn btn-block"><a href="#" style="color:orange;"><b><u>LED Signage</u></b></a></li>
      ...
      <div id="menu2" class="tab-pane fade in" style=" margin-top:20px;">
        <div class="col-md-3">
          <ul class="multi-column-dropdown">
          <li class="btn btn-block"><a href="#" style="color:orange;"><b><u>โปรเจคเตอร์</u></b></a></li>
          <li><a href="#" style="font-size:12px;">- Entry Model</a></li>
          <li><a href="#" style="font-size:12px;">- Feature Model</a></li>
          <li><a href="#" style="font-size:12px;">- Short-Throw</a></li>
          <li><a href="#" style="font-size:12px;">- Ultra Short-Throw</a></li>
          <li><a href="#" style="font-size:12px;">- Mid-High Range</a></li>
          <hr>
          </ul>
        </div>
      </div>
