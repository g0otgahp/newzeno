      ...
      <div id="sidebar" class="col-md-3">
        ...
        <ul id="productlist" class="nav nav-tabs nav-stacked">
          <?php $havecate = $this->uri->segment(4); if (isset($havecate)): ?>
            <?php echo form_open('Product/finding/'.$GroupSelect[0]['categroupId']."/".$CateSelect[0]['cateId']."#productlist"); ?>
          <?php else: ?>
            <?php echo form_open('Product/finding/'.$GroupSelect[0]['categroupId']."#productlist"); ?>
          <?php endif; ?>
